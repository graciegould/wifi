...
def view_results(limit=10):
    ...
    if plan:
        ...
        print("=" * 95)
        print(f"{'Timestamp':<20} {'Download':<15} {'Upload':<13} {'Ping':<8} {'Performance':<15} {'Server':<20}")
        print("-" * 95)
        ...
        print("=" * 80)
        print(f"{'Timestamp':<20} {'Download':<12} {'Upload':<10} {'Ping':<8} {'Server':<25}")
        print("-" * 80)
